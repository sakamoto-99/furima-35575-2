...
ActiveRecord::Schema.define(version: 2021_07_04_092645) do
  ...
  create_table "shipping_address_purchase_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
